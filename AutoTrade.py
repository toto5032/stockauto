...
if __name__ == '__main__': 
    try:
        myToken = read_auth()
        # A130680 TIGER 원유선물
        # A261220 KODEX WTI원유선물
        # A417450 KBSTAR 글로벌수소경제1
        # A500004 신한 브렌트원유 선물
        # A500015 신한 WTI원유 선물
        # A520009 미래에셋 레버리지 원유선물혼합
        # A530031 삼성 레버리지 WTI 원유
        # A550042 QV 레버리지 WTI 원유 선물
        # A580032 KB레버리지 구리선물
        # A500019 신한 레버리지 WTI원유 선물
        symbol_list = ['A130680', 'A261220','A417450', 'A500004', 'A500015', 'A520009', 'A530031', 'A550042','A580032', 'A500019']
